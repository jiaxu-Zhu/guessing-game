...
class GuessingGame {
    ...
    difficulty: 3,
    words: [
    { word: "宇宙", hint: "包含一切物质和能量的无限空间" },
    { word: "星球", hint: "围绕恒星运行的天体" },
    { word: "银河", hint: "横跨夜空的星河带" },
    { word: "黑洞", hint: "引力极强连光都无法逃脱的天体" },
    { word: "彗星", hint: "拖着长尾巴绕太阳运行的冰体" },
    { word: "极光", hint: "极地夜空中的彩色光幕" },
    { word: "日食", hint: "月球遮挡太阳的天文现象" },
    { word: "月食", hint: "地球遮挡太阳光照射月球" },
    { word: "潮汐", hint: "海水受月球引力产生的涨落" },
    { word: "地震", hint: "地壳快速释放能量造成的震动" },
    { word: "台风", hint: "热带海洋上形成的强风暴" },
    { word: "飓风", hint: "大西洋地区的强烈热带气旋" },
    { word: "龙卷风", hint: "旋转极强的柱状气流" },
    { word: "暴雨", hint: "短时间内大量降水的天气" },
    { word: "干旱", hint: "长期缺乏降水的气候状况" },
    { word: "霜冻", hint: "气温低于零度形成的冰晶" },
    { word: "雾气", hint: "近地面水汽凝结形成的朦胧" },
    { word: "沙尘", hint: "风力搬运的细小沙粒" },
    { word: "泥石流", hint: "山区爆发的含泥砂洪流" },
    { word: "滑坡", hint: "斜坡岩土体沿滑动面下滑" },
    { word: "崩塌", hint: "陡峭山坡岩石突然坠落" },
    { word: "海啸", hint: "海底地震引发的巨浪" },
    { word: "珊瑚礁", hint: "珊瑚虫分泌形成的海洋生态" },
    { word: "红树林", hint: "海岸潮间带的木本植物群落" },
    { word: "湿地", hint: "陆地和水域之间的过渡地带" },
    { word: "草原", hint: "以草本植物为主的开阔地带" },
    { word: "苔原", hint: "寒冷地区低矮植被覆盖的地带" },
    { word: "峡谷", hint: "两侧陡峭的深谷地形" },
    { word: "高原", hint: "海拔较高地势平坦的大片土地" },
    { word: "盆地", hint: "四周高中间低的盆状地形" },
    { word: "丘陵", hint: "起伏不大坡度较缓的山地" },
    { word: "岛屿", hint: "被水包围的小块陆地" },
    { word: "半岛", hint: "三面环水一面连陆的陆地" },
    { word: "海峡", hint: "两块陆地之间连接两片海域的通道" },
    { word: "海湾", hint: "海洋伸入陆地的部分" },
    { word: "三角洲", hint: "河流入海口形成的扇形平原" },
    { word: "瀑布", hint: "水流从高处垂直跌落" },
    { word: "湖泊", hint: "陆地上较大的积水区域" },
    { word: "河流", hint: "天然水道流向海洋或湖泊" },
    { word: "泉水", hint: "地下水流出的自然水源" },
    { word: "温泉", hint: "温度高于环境的地下水" },
    { word: "彩虹", hint: "雨后天空出现的七彩拱桥" },
    { word: "沙漠", hint: "干旱少雨，沙子覆盖的广阔地区" },
    { word: "火山", hint: "会喷发岩浆的山" },
    { word: "冰川", hint: "巨大的冰块，缓慢移动" },
    { word: "流星", hint: "划过夜空的发光轨迹" },
    { word: "云朵", hint: "天空中漂浮的白色棉花糖" },
    { word: "闪电", hint: "雷雨天先看到的光" },
    { word: "露珠", hint: "清晨草叶上的小水珠" },
    { word: "雪花", hint: "冬天飘落的六角形冰晶" },
    { word: "雾霾", hint: "空气污染形成的灰色笼罩" },
    { word: "彩虹", hint: "雨后天空出现的七彩拱桥" },
    { word: "沙漠", hint: "干旱少雨，沙子覆盖的广阔地区" },
    { word: "火山", hint: "会喷发岩浆的山" },
    { word: "冰川", hint: "巨大的冰块，缓慢移动" },
    ...
    difficulty: 3,
    animals: [
    { name: "北极狐", hints: ["白色毛皮", "极地生存", "聪明敏捷"] },
    { name: "雪鸮", hints: ["白色羽毛", "夜间捕猎", "北极鸟类"] },
    { name: "驯鹿", hints: ["角很大", "拉雪橇", "寒带动物"] },
    { name: "驼鹿", hints: ["体型巨大", "角如手掌", "森林之王"] },
    { name: "猞猁", hints: ["耳尖有簇毛", "独居猎手", "中型猫科"] },
    { name: "狼獾", hints: ["凶猛无畏", "体型小力量大", "鼬科动物"] },
    { name: "棕熊", hints: ["体型庞大", "冬眠动物", "杂食性"] },
    { name: "黑熊", hints: ["善于爬树", "爱吃蜂蜜", "夜行性"] },
    { name: "浣熊", hints: ["黑眼圈", "爱洗食物", "夜行性"] },
    { name: "负鼠", hints: ["装死高手", "育儿袋", "北美特产"] },
    { name: "土拨鼠", hints: ["会站立", "冬眠专家", "草原啮齿"] },
    { name: "旱獭", hints: ["体型肥大", "洞穴专家", "高山动物"] },
    { name: "松鼠", hints: ["大尾巴", "储存坚果", "树栖啮齿"] },
    { name: "花栗鼠", hints: ["背部有条纹", "颊囊储食", "小型啮齿"] },
    { name: "豪猪", hints: ["浑身是刺", "防御能手", "夜行性"] },
    { name: "穿山甲", hints: ["全身鳞片", "吃蚂蚁", "濒危动物"] },
    { name: "树懒", hints: ["行动缓慢", "倒挂树枝", "热带动物"] },
    { name: "食蚁兽", hints: ["长鼻子", "专吃蚂蚁", "无齿动物"] },
    { name: "犰狳", hints: ["硬壳保护", "挖洞能手", "美洲特产"] },
    { name: "鸭嘴兽", hints: ["鸭嘴模样", "卵生哺乳", "澳大利亚特产"] },
    { name: "针鼹", hints: ["浑身是刺", "吃蚂蚁", "卵生哺乳"] },
    { name: "袋熊", hints: ["方形便便", "挖洞专家", "澳大利亚"] },
    { name: "袋貂", hints: ["夜行性", "长尾巴", "树栖有袋"] },
    { name: "蜜袋鼯", hints: ["滑翔能手", "大眼睛", "可爱萌宠"] },
    { name: "袋鼠猴", hints: ["前肢灵活", "树栖生活", "南美特产"] },
    { name: "树袋熊", hints: ["不是熊", "有袋动物", "澳洲特有"] },
    { name: "短尾猫", hints: ["尾巴很短", "独居猎手", "北美猫科"] },
    { name: "袋鼠", hints: ["有育儿袋", "澳大利亚特产", "用后腿跳跃"] },
    { name: "章鱼", hints: ["有八条触手", "海洋生物", "会喷墨汁"] },
    { name: "蝴蝶", hints: ["色彩斑斓", "从毛毛虫蜕变", "喜欢花朵"] },
    { name: "海豚", hints: ["聪明友善", "会跳跃", "海洋哺乳动物"] },
    { name: "孔雀", hints: ["开屏很漂亮", "有长长的尾羽", "鸟类"] },
    { name: "刺猬", hints: ["身上有刺", "遇到危险会卷成球", "小型哺乳动物"] },
    { name: "蜗牛", hints: ["背着房子走路", "爬得很慢", "有触角"] },
    { name: "蝙蝠", hints: ["夜间活动", "会用回声定位", "会飞的哺乳动物"] },
    { name: "鸳鸯", hints: ["成双成对", "象征爱情", "水鸟"] },
    { name: "海龟", hints: ["长寿象征", "海洋爬行", "有硬壳保护"] },
    { name: "袋鼠", hints: ["有育儿袋", "澳大利亚特产", "用后腿跳跃"] },
    { name: "章鱼", hints: ["有八条触手", "海洋生物", "会喷墨汁"] },
    { name: "蝴蝶", hints: ["色彩斑斓", "从毛毛虫蜕变", "喜欢花朵"] },
    { name: "海豚", hints: ["聪明友善", "会跳跃", "海洋哺乳动物"] },
    ...
    { idiom: "虎头蛇尾", emoji: "🐯🐍" },
    { idiom: "兔死狗烹", emoji: "🐰💀🐕" },
    { idiom: "一诺千金", emoji: "1️⃣💬💎" },
    { idiom: "一字千金", emoji: "1️⃣字💎" },
    { idiom: "一言九鼎", emoji: "1️⃣言9️⃣🔔" },
    { idiom: "一举两得", emoji: "1️⃣✋2️⃣✅" },
    { idiom: "一劳永逸", emoji: "1️⃣💪永✨" },
    { idiom: "一针见血", emoji: "💉🩸" },
    { idiom: "一步登天", emoji: "1️⃣步☁️" },
    { idiom: "一窍不通", emoji: "1️⃣❌🔧" },
    { idiom: "一清二白", emoji: "1️⃣清2️⃣白" },
    { idiom: "一穷二白", emoji: "1️⃣穷2️⃣白" },
    { idiom: "一唱一和", emoji: "🎤1️⃣🎤1️⃣" },
    { idiom: "一五一十", emoji: "1️⃣5️⃣1️⃣0️⃣" },
    { idiom: "一刀两断", emoji: "🔪1️⃣2️⃣" },
    { idiom: "二话不说", emoji: "2️⃣❌💬" },
    { idiom: "三长两短", emoji: "3️⃣➖2️⃣➖" },
    { idiom: "三番五次", emoji: "3️⃣5️⃣" },
    { idiom: "三令五申", emoji: "3️⃣5️⃣📢" },
    { idiom: "三生有幸", emoji: "3️⃣生✨" },
    { idiom: "三思而行", emoji: "3️⃣🤔行动" },
    { idiom: "四分五裂", emoji: "4️⃣5️⃣💔" },
    { idiom: "五花八门", emoji: "5️⃣8️⃣门" },
    { idiom: "六亲不认", emoji: "6️⃣❌家人" },
    { idiom: "七零八落", emoji: "7️⃣0️⃣8️⃣落" },
    { idiom: "八九不离十", emoji: "8️⃣9️⃣1️⃣0️⃣" },
    { idiom: "一马当先", emoji: "🐴⚡🏃" },
    { idiom: "两全其美", emoji: "2️⃣✅✨" },
    { idiom: "三顾茅庐", emoji: "3️⃣🏠👨" },
    { idiom: "四脚朝天", emoji: "4️⃣🦵☀️" },
    { idiom: "五光十色", emoji: "5️⃣✨🌈" },
    { idiom: "六六大顺", emoji: "6️⃣6️⃣✅" },
    { idiom: "七步之才", emoji: "7️⃣📚💡" },
    { idiom: "八面玲珑", emoji: "8️⃣💎✨" },
    { idiom: "九死一生", emoji: "9️⃣💀✅" },
    { idiom: "十拿九稳", emoji: "1️⃣0️⃣9️⃣✅" },
    { idiom: "百折不挠", emoji: "1️⃣0️⃣0️⃣💪" },
    { idiom: "千言万语", emoji: "1️⃣0️⃣0️⃣🗣️" },
    { idiom: "万众一心", emoji: "1️⃣0️⃣0️⃣0️⃣❤️" },
    { idiom: "亿兆一心", emoji: "1️⃣🌟0️⃣❤️" },
    { idiom: "掩耳盗钟", emoji: "👂🔔😂" },
    { idiom: "拔苗助长", emoji: "🌱✂️⬆️" },
    { idiom: "牛头马面", emoji: "🐂🐴" },
    { idiom: "羊入虎口", emoji: "🐑🐯" },
    { idiom: "蜻蜓点水", emoji: "🦟💧" },
    { idiom: "蝴蝶恋花", emoji: "🦋🌸" },
